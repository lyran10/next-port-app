        ...
        >
          ...
          <Card>
            ...
            <div className="flex flex-col mt-2">
              <span className="text-zinc-400 tracking-wide leading-relaxed text-sm">{item.description}</span>
              <span className="text-zinc-400 tracking-wide leading-relaxed text-sm">{item.slug}</span>
